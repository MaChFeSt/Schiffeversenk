...
public class Window extends JFrame{
	...
	public Window () {
		...
		if (mode == 1) {   ///HOST SPIEL
			...
			// wir m¸ssen die Boardsize senden
			// METHODE, DIE IN AI GRID 20 oder 21 reinschreibt!
			// ¸berpr¸fen ob gewonnen 
		}
		
		if (mode == 2) {   ///JOIN SPIEL
			
			/// WIR M‹SSEN DIE BOARDSIZE BEKOMMEN
	 ...
	 * Mit einem Click auf den Place Button werden die Schiffe zuf√§llig platziert.
				...
				if(startint==0) {
					...
					start.addMouseListener(new MouseAdapter() {
						...
						public void mouseClicked(MouseEvent e){
							...
							else { // wenn versusAI, dann wird der array mit Schiffen gef¸llt.
								AI a = new AI();
								int end=0;
